const level1 = new Level(
  ...
  [
    new Coin("./img/4. Marcadores/1. Coins/1.png", 600, 270),
    new Coin("./img/4. Marcadores/1. Coins/1.png", 750, 270),
    new Coin("./img/4. Marcadores/1. Coins/1.png", 750, 150),
    new Coin("./img/4. Marcadores/1. Coins/1.png", 1000, 50),
    new Coin("./img/4. Marcadores/1. Coins/1.png", 1150, 50),
    new Coin("./img/4. Marcadores/1. Coins/1.png", 1300, 50),
    new Coin("./img/4. Marcadores/1. Coins/1.png", 1500, 360),
    new Coin("./img/4. Marcadores/1. Coins/1.png", 1650, 290),
    new Coin("./img/4. Marcadores/1. Coins/1.png", 1800, 220),
    new Coin("./img/4. Marcadores/1. Coins/1.png", 1950, 150),
